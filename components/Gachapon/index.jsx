...
const Gachapon = () => {
  ...
  const handleSwitch = () => {
    ...
    setTimeout(() => setSwitch(false), 700);
  }
  ...
  return (
    <Container>
      ...
      {/* switch */}
      <Switcher
        style={{ transform: isSwitched ? 'rotate(-90deg)' : 'rotate(0deg)' }}
        tabIndex={0}
        viewBox="0 0 154 155"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
        onClick={!isSwitched ? handleSwitch : () => {}}
      >
        <circle cx="76.5828" cy="77.7004" r="43.5" transform="rotate(-45 76.5828 77.7004)" fill="#C6D2D5" stroke="#000000" strokeWidth="10"/>
        <path d="M32.7422 110.934C30.399 108.591 30.399 104.792 32.7422 102.449L101.732 33.4592C104.075 31.1161 107.874 31.1161 110.217 33.4592L120.117 43.3587C122.46 45.7018 122.46 49.5008 120.117 51.844L51.127 120.834C48.7838 123.177 44.9848 123.177 42.6417 120.834L32.7422 110.934Z" fill="#C6D2D5" stroke="#000000" strokeWidth="10"/>
      </Switcher>
      
      <svg style={{ width: '300px' }} viewBox="0 0 617 979" fill="none" xmlns="http://www.w3.org/2000/svg">
        <circle cx="308.5" cy="388.5" r="302" fill="#DEECF3" stroke="#000000" strokeWidth="13"/>
        <path d="M308.5 5.14625C274.1 2.74625 257.833 30.4796 254 44.6462H361C357.833 32.4796 342.9 7.54625 308.5 5.14625Z" fill="#4aa399" stroke="#000000" strokeWidth="10" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M105 902L112.5 646H511.5L519 894.5L105 902Z" fill="#4aa399" stroke="#000000" strokeWidth="10" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M517.219 611C345.719 677.5 173.552 639.5 101.219 611C88.219 623.5 102.552 645 111.219 647.5C354.219 724.5 490.719 656.5 517.219 639C538.419 625 526.052 614.5 517.219 611Z" fill="#4aa399" stroke="#000000" strokeWidth="10" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M524.709 850.027C329.109 940.027 159.542 887.527 99.2088 850.027C71.2088 859.227 79.8755 895.194 87.7088 912.027C291.309 1022.43 476.875 958.027 544.209 912.027C549.009 860.827 533.209 849.36 524.709 850.027Z" fill="#4aa399" stroke="#000000" strokeWidth="10" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M364.5 892.246C320.5 833.846 278.5 867.912 263 892.246V952.746C263 961.246 276.5 972.246 314 973.246C344 974.046 360.167 959.912 364.5 952.746V892.246Z" fill="#C7D2D5" stroke="#000000" strokeWidth="10" strokeLinecap="round" strokeLinejoin="round"/>
        
        {/* egg */}
        <Egg onClick={handleClick} isActive={isActive}>
          <circle cx="313.5" cy="885.5" r="40.5" fill="#F3D478" stroke="#57172F" strokeWidth="10"/>
